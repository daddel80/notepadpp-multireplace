...
{ L"panel_formula_support", L"Formula Support" },
{ L"engine_name_lua", L"Lua" },
{ L"engine_name_exprtk", L"ExprTk" },
{ L"tooltip_engine_selector", L"Active engine: $REPLACE_STRING. Click to change." },
...
{ L"tooltip_header_formula_support", L"Formula Support" },
...
{ L"status_no_entries_selected", L"Select entries in the list or disable the list." },
...
{ L"status_saved_items_to_mrl", L"$REPLACE_STRING items saved to MRL." },
{ L"status_save_all_done", L"$REPLACE_STRING list(s) saved." },
...
{ L"status_scan_unreadable_folders", L" $REPLACE_STRING folder(s) unreadable." },
{ L"status_duplicates_skipped", L" $REPLACE_STRING duplicate list row(s) skipped." },
...
{ L"msgbox_title_formula_support_syntax_error", L"Formula Support: Compile Error" },
{ L"msgbox_title_formula_support_execution_error", L"Formula Support: Runtime Error" },
...
{ L"msgbox_formula_support_execution_error_engine", L"List entry #$REPLACE_STRING1 ($REPLACE_STRING2) - Runtime Error at position $REPLACE_STRING3:<br/>$REPLACE_STRING4" },
...
{ L"msgbox_recoverable_error_details_exprtk", L"Expression \"$REPLACE_STRING\" produced an invalid number (NaN or Inf).\n\nNaN: a capture couldn't be parsed as a number, or a string variable was used numerically. Inf: division by zero or overflow.\n\nUse txt(N) for raw text, or guard against invalid values explicitly." },
...
{ L"msgbox_flowtabs_intro_body",
  ...
  L"•  Before saving: Click the Flow-Tabs button again to remove inserted tabs." },
...
{ L"dock_scan_unreadable_folders", L"; $REPLACE_STRING folder(s) unreadable" },
{ L"dock_docs_scan_suffix", L" [$REPLACE_STRING1 document(s) searched$REPLACE_STRING2]" },
{ L"dock_docs_filtered", L", $REPLACE_STRING1 excluded by filter" },
...
{ L"dock_skip_readonly", L"read-only" },
{ L"dock_skip_open_unsaved", L"open with unsaved changes" },
{ L"dock_skip_unencodable", L"not encodable" },
...
{ L"menu_reopen_on_startup", L"&Reopen on Startup" },
...
{ L"tab_menu_save_a_copy",         L"Save a Copy..." },
{ L"tab_menu_reload",              L"Reload" },
...
const UITextMapping kControlTextMappings[] = {
    ...
    { IDC_FORMULA_SUPPORT_CHECKBOX,      L"panel_formula_support" },
    { IDC_FORMULA_SUPPORT_HELP,          L"panel_help" },
...
const UIHeaderMapping kHeaderTextMappings[] = {
    ...
    { ColumnID::FORMULA_SUPPORT, L"header_formula_support" },
...
const UIHeaderMapping kHeaderTooltipMappings[] = {
    ...
    { ColumnID::FORMULA_SUPPORT, L"tooltip_header_formula_support" },
