...
{ L"tooltip_bookmark_matches", L"Bookmark Matches" },
...
{ L"status_occurrences_bookmarked", L"$REPLACE_STRING matches bookmarked." },
...
{ L"config_chk_timestamp", L"Modified" },
...
const UITextMapping kControlTextMappings[] = {
    ...
    { IDC_MARK_MATCHES_BUTTON,         L"panel_mark" },
...
const UITooltipMapping kTooltipMappings[] = {
    ...
    { IDC_BOOKMARK_MATCHES_BUTTON,     L"tooltip_bookmark_matches" },
