...
namespace {
    ...
    // RAII guard for _suppressLiveWidthSync (SuppressWidthSyncGuard) now
    // lives in MultiReplacePanel.h as a MultiReplace nested type, shared
    // with MultiReplacePanel_FlowTabs.cpp.
