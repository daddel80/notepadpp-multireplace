...
void MultiReplace::moveAndResizeControls() {
    ...
    const int controlIds[] = {
        ...
        IDC_PATH_DISPLAY, IDC_STATS_DISPLAY, IDC_DIR_EDIT, IDC_FILTER_EDIT, IDC_FILTER_HELP, IDC_SUBFOLDERS_CHECKBOX, 
        IDC_HIDDENFILES_CHECKBOX, IDC_BROWSE_DIR_BUTTON, IDC_REPLACE_IN_FILES_GROUP, IDC_DIR_PROGRESS_BAR, IDC_STATUS_MESSAGE
    };
...
bool MultiReplace::handleReplaceAllButton(bool showCompletionMessage, const std::filesystem::path* explicitPath) {
    ...
    // reads Codepage for Performance reason
