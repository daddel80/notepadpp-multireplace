...
#define IDC_BOOKMARK_MATCHES_CHECKBOX   5019
...
// ===================================================================
//  5960-5969 - Use-List button context menu
// ===================================================================
#define IDM_KEEP_LIST_VISIBLE           5960
...
#define MIN_WIDTH                   792     // Minimum width (resize limit)
#define MIN_HEIGHT                  372     // Minimum height with list (resize limit)
#define SHRUNK_HEIGHT               236     // Minimum height without list (status row at 209 + toggle at 207)
